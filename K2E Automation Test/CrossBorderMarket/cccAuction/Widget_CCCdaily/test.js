...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='widget-toolbar app_dropDownHolder dropDownHolder'] ul[class='dropdown-menu .dropDownMenu'] li",
        ...
        {
            console.log("Checking if Widget_"+widgetTitle+" Menu Items Exists");
            test.assertExists("div[id='"+widgetID+"'] div[class='widget-toolbar app_dropDownHolder dropDownHolder'] ul[class='dropdown-menu .dropDownMenu'] li", "TEST1 --"+widgetTitle+" Menu Items Exists");
            ...
            console.log("Downloading Profile_Graph_1");
            this.wait(1000, function()
            {
                casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'Profile_Graph_1'+imageType);
            });

        },
        function fail()
        {
            console.log("TEST1 --Widget Menu "+widgetTitle+" Configure Button Does not Exists");
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'_Test1_Fail'+imageType);
        });

    //Display Graph 2
    casper.then(function()
    {
        console.log("Downloading Profile_Graph_2");
        ...
        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'Profile_Graph_2'+imageType);
        });
    });
...
//CheckBox
    ...
    casper.waitForSelector("div[class='configMultiSelectDropDownHolder row'] div div[class='btn-group'] button[class='multiselect dropdown-toggle btn btn-default']",
        function success()
        {
            console.log("Checking if Widget_"+widgetTitle+" Check Box Exists");
            test.assertExists("div[class='configMultiSelectDropDownHolder row'] div div[class='btn-group'] button[class='multiselect dropdown-toggle btn btn-default']", "TEST8 --"+widgetTitle+" Check Box Exists");
            console.log("Clicking on MultiCheck Box");
            this.click("div[class='configMultiSelectDropDownHolder row'] div div[class='btn-group'] button[class='multiselect dropdown-toggle btn btn-default']");
            this.click("div[class='configMultiSelectDropDownHolder row'] div div[class='btn-group open'] ul li:nth-child(1) a label input");
            this.click("button[id='apply']");

            console.log("Downloading CheckBox_MultiCheck_Check_1");
            this.wait(1000, function()
            {
                casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'CheckBox_MultiCheck_1'+imageType);
            });
        },
        function fail()
        {
    ...
    casper.then(function()
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configMultiSelectDropDownHolder row'] div div[class='btn-group'] button[class='multiselect dropdown-toggle btn btn-default']");
        this.click("div[class='configMultiSelectDropDownHolder row'] div div[class='btn-group open'] ul li:nth-child(2) a label input");
        this.click("button[id='apply']");
        console.log("Downloading CheckBox_MultiCheck_Check_2");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'CheckBox_Check_MultiCheck_2'+imageType);
        });
    });
    ...
    casper.then(function()
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configMultiSelectDropDownHolder row'] div div[class='btn-group'] button[class='multiselect dropdown-toggle btn btn-default']");
        this.click("div[class='configMultiSelectDropDownHolder row'] div div[class='btn-group open'] ul li:nth-child(3) a label input");
        this.click("button[id='apply']");
        console.log("Downloading CheckBox_MultiCheck_Check_3");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'CheckBox_Check_MultiCheck_3'+imageType);
        });
    });
    ...
    casper.then(function()
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configMultiSelectDropDownHolder row'] div div[class='btn-group'] button[class='multiselect dropdown-toggle btn btn-default']");
        this.click("div[class='configMultiSelectDropDownHolder row'] div div[class='btn-group open'] ul li:nth-child(4) a label input");
        this.click("button[id='apply']");
        console.log("Downloading CheckBox_MultiCheck_Check_4");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'CheckBox_Check_MultiCheck_4'+imageType);
        });
    });
    ...
    casper.then(function()
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configMultiSelectDropDownHolder row'] div div[class='btn-group'] button[class='multiselect dropdown-toggle btn btn-default']");
        this.click("div[class='configMultiSelectDropDownHolder row'] div div[class='btn-group open'] ul li:nth-child(5) a label input");
        this.click("button[id='apply']");
        console.log("Downloading CheckBox_MultiCheck_Check_5");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'CheckBox_Check_MultiCheck_5'+imageType);
        });
    });
    ...
    casper.then(function()
    {
        console.log("Downloading Mar_3");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configDropDownHolder row'] div:nth-child(2) button[class='btn btn-primary dropdown-toggle']");
        this.click("div[class='configDropDownHolder row'] div:nth-child(2) ul li:nth-child(3)");
        this.click("button[id='apply']");
    ...
    casper.then(function()
    {
        console.log("Downloading Apr_4");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configDropDownHolder row'] div:nth-child(2) button[class='btn btn-primary dropdown-toggle']");
        this.click("div[class='configDropDownHolder row'] div:nth-child(2) ul li:nth-child(4)");
        this.click("button[id='apply']");
    ...
    casper.then(function()
    {
        console.log("Downloading May_5");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configDropDownHolder row'] div:nth-child(2) button[class='btn btn-primary dropdown-toggle']");
        this.click("div[class='configDropDownHolder row'] div:nth-child(2) ul li:nth-child(5)");
        this.click("button[id='apply']");
    ...
    casper.then(function()
    {
        console.log("Downloading Jun_6");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configDropDownHolder row'] div:nth-child(2) button[class='btn btn-primary dropdown-toggle']");
        this.click("div[class='configDropDownHolder row'] div:nth-child(2) ul li:nth-child(6)");
        this.click("button[id='apply']");
    ...
    casper.then(function()
    {
        console.log("Downloading Jul_7");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configDropDownHolder row'] div:nth-child(2) button[class='btn btn-primary dropdown-toggle']");
        this.click("div[class='configDropDownHolder row'] div:nth-child(2) ul li:nth-child(7)");
        this.click("button[id='apply']");
    ...
    casper.then(function()
    {
        console.log("Downloading Aug_8");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configDropDownHolder row'] div:nth-child(2) button[class='btn btn-primary dropdown-toggle']");
        this.click("div[class='configDropDownHolder row'] div:nth-child(2) ul li:nth-child(8)");
        this.click("button[id='apply']");
    ...
    casper.then(function()
    {
        console.log("Downloading Sep_9");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configDropDownHolder row'] div:nth-child(2) button[class='btn btn-primary dropdown-toggle']");
        this.click("div[class='configDropDownHolder row'] div:nth-child(2) ul li:nth-child(9)");
        this.click("button[id='apply']");
    ...
    casper.then(function()
    {
        console.log("Downloading Oct_10");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configDropDownHolder row'] div:nth-child(2) button[class='btn btn-primary dropdown-toggle']");
        this.click("div[class='configDropDownHolder row'] div:nth-child(2) ul li:nth-child(10)");
        this.click("button[id='apply']");
    ...
    casper.then(function()
    {
        console.log("Downloading Nov_11");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configDropDownHolder row'] div:nth-child(2) button[class='btn btn-primary dropdown-toggle']");
        this.click("div[class='configDropDownHolder row'] div:nth-child(2) ul li:nth-child(11)");
        this.click("button[id='apply']");
    ...
    casper.then(function()
    {
        console.log("Downloading Dec_12");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configDropDownHolder row'] div:nth-child(2) button[class='btn btn-primary dropdown-toggle']");
        this.click("div[class='configDropDownHolder row'] div:nth-child(2) ul li:nth-child(12)");
        this.click("button[id='apply']");
    ...
    casper.then(function()
    {
        console.log("Downloading year_2009");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        ...
        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'year_2009'+imageType);
        });
    });

    casper.then(function()
    {
        console.log("Downloading year_2010");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configDropDownHolder row'] div:nth-child(3) button[class='btn btn-primary dropdown-toggle']");
        ...
        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'year_2010'+imageType);
        });
    });

    casper.then(function()
    {
        console.log("Downloading year_2011");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configDropDownHolder row'] div:nth-child(3) button[class='btn btn-primary dropdown-toggle']");
        ...
        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'year_2011'+imageType);
        });
    });

    casper.then(function()
    {
        console.log("Downloading year_2012");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configDropDownHolder row'] div:nth-child(3) button[class='btn btn-primary dropdown-toggle']");
        ...
        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'year_2012'+imageType);
        });
    });

    casper.then(function()
    {
        console.log("Downloading year_2013");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configDropDownHolder row'] div:nth-child(3) button[class='btn btn-primary dropdown-toggle']");
        ...
        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'year_2013'+imageType);
        });
    });

    casper.then(function()
    {
        console.log("Downloading year_2014");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configDropDownHolder row'] div:nth-child(3) button[class='btn btn-primary dropdown-toggle']");
        ...
        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'year_2014'+imageType);
        });
    });

    casper.then(function()
    {
        console.log("Downloading year_2015");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configDropDownHolder row'] div:nth-child(3) button[class='btn btn-primary dropdown-toggle']");
        ...
        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'year_2015'+imageType);
        });
    });

    casper.then(function()
    {
        console.log("Downloading year_2016");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configDropDownHolder row'] div:nth-child(3) button[class='btn btn-primary dropdown-toggle']");
        ...
        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'year_2016'+imageType);
        });
    });
