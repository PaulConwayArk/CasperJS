...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    casper.then(function()
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("button[class='btn btn-primary dropdown-toggle']");
        this.click("div[class='btn-group open'] ul[class='dropdown-menu'] li:nth-child(5) a");
        this.click("button[id='apply']");
    ...
    casper.then(function()
    {
        ...
        this.click("div[id='"+widgetID+"'] div[class='widget-toolbar app_dropDownHolder dropDownHolder'] ul[class='dropdown-menu .dropDownMenu'] li:nth-child(5) a");
        //Screen Capture
        this.wait(1000, function()
        {
    ...
    casper.then(function()
    {
        console.log("Downloading Profile_1");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
    ...
    casper.then(function()
    {
        console.log("Downloading Profile_2");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configDropDownHolder row'] div:nth-child(2) button[class='btn btn-primary dropdown-toggle']");
