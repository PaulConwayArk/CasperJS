...
//Widget ID
var widgetID = "wid-id-803";
//Widget Title
var widgetTitle = "Renewable_Production_Actual_and_Forecast_hourly";
//Needed to add this title as the title is as shown above but it wont save a image with a ":" within it
var widgetTitle2 ="Renewable Production: Actual and Forecast (hourly)";
