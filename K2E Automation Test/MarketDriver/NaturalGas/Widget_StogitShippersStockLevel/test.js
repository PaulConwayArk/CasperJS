...
casper.test.begin('UserLogin',function UserLogin(test)
{
    ...
    {
        this.reload();
        console.log("EXPECTED NUMBER OF TEST: 21");
...
casper.test.begin("Widget --> "+widgetTitle2+"",function (test)
{
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Download Data'] i",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Download Data'] i", "TEST4 --"+widgetTitle+" Download Button Exists");
        ...
        function fail()
        {
            console.log("TEST4 --Widget Menu "+widgetTitle+" Download Button Does not Exists");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Collapse'] i",
        ...
        function fail()
        {
            console.log("TEST5 --Widget Menu "+widgetTitle+" Collapse Button Does not Exists");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(1)",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(1)", "TEST8 --"+widgetTitle+" Download Chart Button Exists");
        },
        function fail()
        {
            console.log("TEST8 --Widget Menu "+widgetTitle+" Download Chart Button Does not Exists");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(3)",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(3)", "TEST9 --"+widgetTitle+" Download PNG Button Exists");
        },
        function fail()
        {
            console.log("TEST9 --Widget Menu "+widgetTitle+" Download PNG Button Does not Exists");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(4)",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(4)", "TEST10 --"+widgetTitle+" Download JPEG Button Exists");
        },
        function fail()
        {
            console.log("TEST10 --Widget Menu "+widgetTitle+" Download JPEG Button Does not Exists");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(5)",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(5)", "TEST11 --"+widgetTitle+" Download PDF Button Exists");
        },
        function fail()
        {
            console.log("TEST11 --Widget Menu "+widgetTitle+" Download PDF Button Does not Exists");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(6)",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(6)", "TEST12 --"+widgetTitle+" Download SVG Button Exists");
        },
        function fail()
        {
            console.log("TEST12 --Widget Menu "+widgetTitle+" Download SVG Button Does not Exists");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] svg g[class='highcharts-legend']",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] svg g[class='highcharts-legend']", "TEST13 --"+widgetTitle+" Legend Exists");
        },
        function fail()
        {
            console.log("TEST13 --Widget Menu "+widgetTitle+" Legend Does not Exists");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] svg g[class='highcharts-legend'] g g:nth-child(1)",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] svg g[class='highcharts-legend'] g g:nth-child(1)", "TEST14 --"+widgetTitle+" first child of the Legend Exists");
        },
        function fail()
        {
            console.log("TEST14 --Widget Menu "+widgetTitle+" first child of the Legend Does not Exists");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] svg g[class='highcharts-legend'] g g:nth-child(2)",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] svg g[class='highcharts-legend'] g g:nth-child(2)", "TEST15 --"+widgetTitle+" second child of the Legend Exists");
        },
        function fail()
        {
            console.log("TEST15 --Widget Menu "+widgetTitle+" second child of the Legend Does not Exists");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] svg g[class='highcharts-legend'] g g:nth-child(3)",
        ...
        {
            console.log("Checking if Widget_"+widgetTitle+" Legend second child Exists");
            test.assertExists("div[id='"+widgetID+"'] svg g[class='highcharts-legend'] g g:nth-child(3)", "TEST16 --"+widgetTitle+" third child of the Legend Exists");
        },
        function fail()
        {
            console.log("TEST16 --Widget Menu "+widgetTitle+" third child of the Legend Does not Exists");
    ...
    //Click seventh child of the legend
    casper.then(function()
    {
        console.log("Clicking seventh child of the Legends Button");
        this.click("div[id='"+widgetID+"'] svg g[class='highcharts-legend'] g g:nth-child(7)");
        //Screen Capture
        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'Legend_7_Clicked'+imageType);
        });
    });

    //Click eigth child of the legend
    casper.then(function()
    {
        console.log("Clicking eigth child of the Legends Button");
        this.click("div[id='"+widgetID+"'] svg g[class='highcharts-legend'] g g:nth-child(8)");
        //Screen Capture
        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'Legend_8_Clicked'+imageType);
        });
    });

    //Click ninth child of the legend
    casper.then(function()
    {
        console.log("Clicking ninth child of the Legends Button");
        this.click("div[id='"+widgetID+"'] svg g[class='highcharts-legend'] g g:nth-child(9)");
        //Screen Capture
        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'Legend_9_Clicked'+imageType);
        });
    });

    //Click tenth child of the legend
    casper.then(function()
    {
        console.log("Clicking tenth child of the Legends Button");
        this.click("div[id='"+widgetID+"'] svg g[class='highcharts-legend'] g g:nth-child(10)");
        //Screen Capture
        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'Legend_10_Clicked'+imageType);
        });
    });

    //Reimplement chart legend
    casper.then(function()
    {
        console.log("Clicking third child of the Legends Button");
        this.click("div[id='"+widgetID+"'] svg g[class='highcharts-legend'] g g:nth-child(1)");
