...
casper.test.begin("Widget --> "+widgetTitle2+"",function (test)
{
    ...
    //Click on the SICI and capture image of change on table
    casper.waitForSelector("div[class='configDropDownHolder row'] div:nth-child(1) ul li:nth-child(5)",
        function success()
        {
            console.log("Checking if Widget_"+widgetTitle+" dropdown Exists");
            test.assertExists("div[class='configDropDownHolder row'] div:nth-child(1) ul li:nth-child(5)", "TEST8 --"+widgetTitle+" Check Box Exists");
            ...
            this.click("div[class='configDropDownHolder row'] div:nth-child(1) ul li:nth-child(5)");
            this.click("button[id='apply']");
    ...
    casper.then(function()
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configDropDownHolder row'] div:nth-child(1) div[class='btn-group'] button[class='btn btn-primary dropdown-toggle']");
        this.click("div[class='configDropDownHolder row'] div:nth-child(1) ul li:nth-child(10)");
        this.click("button[id='apply']");
    ...
    casper.then(function()
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("div[class='configDropDownHolder row'] div:nth-child(1) div[class='btn-group'] button[class='btn btn-primary dropdown-toggle']");
        this.click("div[class='configDropDownHolder row'] div:nth-child(1) ul li:nth-child(3)");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i",
        ...
        {
            console.log("Checking if Widget_"+widgetTitle+" Configure Button Exists");
            test.assertExists("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i", "TEST14 --"+widgetTitle+" Configure Button Exists");
            console.log("Clicking on Configure Button");
            this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        },
        function fail()
        {
            console.log("TEST14 --Widget Menu "+widgetTitle+" Configure Button Does not Exists");
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'_Test14_Fail'+imageType);
        });

    //Click on the SICI and capture image of change on table
    casper.waitForSelector("div[class='configDropDownHolder row'] div:nth-child(2) button[class='btn btn-primary dropdown-toggle']",
        function success()
        {
            console.log("Checking if Widget_"+widgetTitle+" dropdown Exists");
            test.assertExists("div[class='configDropDownHolder row'] div:nth-child(2) button[class='btn btn-primary dropdown-toggle']", "TEST15 --"+widgetTitle+" Check Box Exists");
            console.log("Clicking on Check Box");
            ...
            console.log("Downloading Scope_1");
            this.wait(1000, function()
            {
                casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'Scope_1'+imageType);
            });
        },
        function fail()
        {
            console.log("TEST15 --Widget Menu "+widgetTitle+" Check Box Does not Exists");
    ...
    casper.then(function()
    {
        ...
        this.click("button[id='apply']");
        console.log("Downloading Scope_2");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'Scope_2'+imageType);
        });
    });
