...
casper.test.begin("Widget --> "+widgetTitle+"",function (test)
{
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Download Data'] i",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Download Data'] i", "TEST5 --"+widgetTitle+" Download Button Exists");
        ...
        function fail()
        {
            console.log("TEST5 --Widget Menu "+widgetTitle+" Download Button Does not Exists");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Collapse'] i",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Collapse'] i", "TEST6 --"+widgetTitle+" Collapse Button Exists");
        ...
        function fail()
        {
            console.log("TEST6 --Widget Menu "+widgetTitle+" Collapse Button Does not Exists");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Fullscreen'] i",
        ...
        {
            console.log("Checking if Widget_"+widgetTitle+" the Download Button Exists");
            test.assertExists("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Fullscreen'] i", "TEST7 --"+widgetTitle+" Download Button Exists");
            console.log("Clicking on Download Button");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] svg g[class='highcharts-button']",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] svg g[class='highcharts-button']", "TEST8 --"+widgetTitle+" Download Chart Button Exists");
        },
        function fail()
        {
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(1)",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(1)", "TEST9 --"+widgetTitle+" Download Chart Button Exists");
        },
        function fail()
        {
            console.log("TEST9 --Widget Menu "+widgetTitle+" Download Chart Button Does not Exists");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(3)",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(3)", "TEST10 --"+widgetTitle+" Download PNG Button Exists");
        },
        function fail()
        {
            console.log("TEST10 --Widget Menu "+widgetTitle+" Download PNG Button Does not Exists");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(4)",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(4)", "TEST11 --"+widgetTitle+" Download JPEG Button Exists");
        },
        function fail()
        {
            console.log("TEST11 --Widget Menu "+widgetTitle+" Download JPEG Button Does not Exists");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(5)",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(5)", "TEST12 --"+widgetTitle+" Download PDF Button Exists");
        },
        function fail()
        {
            console.log("TEST12 --Widget Menu "+widgetTitle+" Download PDF Button Does not Exists");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(6)",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(6)", "TEST13 --"+widgetTitle+" Download SVG Button Exists");
        },
        function fail()
        {
            console.log("TEST13 --Widget Menu "+widgetTitle+" Download SVG Button Does not Exists");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] svg g[class='highcharts-legend']",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] svg g[class='highcharts-legend']", "TEST14 --"+widgetTitle+" Legend Exists");
        },
        function fail()
        {
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] svg g[class='highcharts-legend'] g g:nth-child(1)",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] svg g[class='highcharts-legend'] g g:nth-child(1)", "TEST15 --"+widgetTitle+" first child of the Legend Exists");
        },
        function fail()
        {
            console.log("TEST15 --Widget Menu "+widgetTitle+" first child of the Legend Does not Exists");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] svg g[class='highcharts-legend'] g g:nth-child(2)",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] svg g[class='highcharts-legend'] g g:nth-child(2)", "TEST16 --"+widgetTitle+" second child of the Legend Exists");
        },
        function fail()
        {
            console.log("TEST16 --Widget Menu "+widgetTitle+" first child of the Legend Does not Exists");
