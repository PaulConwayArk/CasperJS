...
//Widget ID
var widgetID = "wid-id-111";
//Widget Title
var widgetTitle = "Renewable_Production_Forecast_Daily_Average";
//Needed to add this title as the title is as shown above but it wont save a image with a ":" within it
var widgetTitle2 ="Renewable Production Forecast (daily average)";
...
casper.test.begin("Widget --> "+widgetTitle2+"",function (test)
{
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(1)",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(1)", "TEST11 --"+widgetTitle+" Download Chart Button Exists");
        },
        function fail()
        {
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(3)",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(3)", "TEST12 --"+widgetTitle+" Download PNG Button Exists");
        },
        function fail()
        {
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(4)",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(4)", "TEST13 --"+widgetTitle+" Download JPEG Button Exists");
        },
        function fail()
        {
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(5)",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(5)", "TEST14 --"+widgetTitle+" Download PDF Button Exists");
        },
        function fail()
        {
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(6)",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] div[class='highcharts-contextmenu'] div div:nth-child(6)", "TEST15 --"+widgetTitle+" Download SVG Button Exists");
        },
        function fail()
        {
