...
//Widget ID
var widgetID = "wid-id-114";
//Widget Title
var widgetTitle = "Power_European_Spot_Prices_hourly";
//Needed to add this title as the title is as shown above but it wont save a image with a ":" within it
var widgetTitle2 ="Power European Spot Prices (hourly)";
...
casper.test.begin('UserLogin',function UserLogin(test)
{
    ...
    {
        this.reload();
        console.log("EXPECTED NUMBER OF TEST: 23");
...
casper.test.begin("Widget --> "+widgetTitle2+"",function (test)
{
    ...
    casper.then(function()
    {
        console.log("Clicking sixth child of the Legends Button to reimplemented chart");
        this.click("div[id='"+widgetID+"'] svg g[class='highcharts-legend'] g g:nth-child(6)");
        //Screen Capture
        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'Legend_6_Clicked_Reimplemented'+imageType);
        });
    });
    ...
    casper.then(function()
    {
        console.log("Clicking seventh child of the Legends Button to reimplemented chart");
        this.click("div[id='"+widgetID+"'] svg g[class='highcharts-legend'] g g:nth-child(7)");
        //Screen Capture
        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'Legend_7_Clicked_Reimplemented'+imageType);
        });
    });
    //Run Test
    casper.run(function()
