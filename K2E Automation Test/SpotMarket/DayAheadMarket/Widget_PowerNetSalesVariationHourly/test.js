...
//Widget ID
var widgetID = "wid-id-104";
//Widget Title
var widgetTitle = "Power_Net_Sales_Variation_hourly";
//Needed to add this title as the title is as shown above but it wont save a image with a ":" within it
var widgetTitle2 ="Power Net Sales Variation (hourly)";
...
casper.test.begin("Widget --> "+Page+"",function (test)
{
    var navOpened = false;
    ...
    casper.then(function()
    {
        ...
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Collapse']");
        //Screen Capture
        this.wait(1000, function()
        {
