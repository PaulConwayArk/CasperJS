...
//Widget ID
var widgetID = "wid-id-102";
//Widget Title
var widgetTitle = "Power_CrossBorder_Flows_Daily_Total";
//Needed to add this title as the title is as shown above but it wont save a image with a ":" within it
var widgetTitle2 ="Power CrossBorder Flows (daily total)";
...
casper.test.begin("Widget --> "+widgetTitle2+"",function (test)
{
    ...
    //Click on the AUST and capture image of change on table
    casper.waitForSelector("span[class='gridCheckboxEdit'] label input",
        function success()
        {
            ...
            test.assertExists("span[class='gridCheckboxEdit'] label input[id='AUST']", "TEST8 --"+widgetTitle+" Check Box Exists");
            console.log("Clicking on Check Box");
            this.click("span[class='gridCheckboxEdit'] label input[id='AUST']");
            this.click("button[id='apply']");
    ...
    //Click on the COAC and capture image of change on table
    casper.then(function()
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='COAC']");
        this.click("button[id='apply']");
    ...
    //Click on the CORS and capture image of change on table
    casper.then(function()
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='CORS']");
        this.click("button[id='apply']");
    ...
    //Click on the FRAN and capture image of change on table
    casper.then(function()
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='FRAN']");
        this.click("button[id='apply']");
    ...
    //Click on the GREC and capture image of change on table
    casper.then(function()
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='GREC']");
        this.click("button[id='apply']");
    ...
    //Click on the MALT and capture image of change on table
    casper.then(function()
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='MALT']");
        this.click("button[id='apply']");
        console.log("Downloading Config_Graph_Check_6");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'Config_Graph_Check_6'+imageType);
        });
    });

    //Click on the SLOV and capture image of change on table
    casper.then(function()
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='SLOV']");
        this.click("button[id='apply']");
        console.log("Downloading Config_Graph_Check_7");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'Config_Graph_Check_7'+imageType);
        });
    });

    //Click on the SVIZ and capture image of change on table
    casper.then(function()
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='SVIZ']");
        this.click("button[id='apply']");
        console.log("Downloading Config_Graph_Check_8");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'Config_Graph_Check_8'+imageType);
        });
    });
    ...
    casper.then(function()
    {
        ...
        this.click("span[class='gridCheckboxEdit'] label input[id='MALT']");
        this.click("button[id='apply']");
        console.log("Downloading Config_Graph_Check_6_Checked");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'Config_Graph_Check_6_Checked'+imageType);
        });
    });
    ...
    casper.then(function()
    {
        ...
        this.click("span[class='gridCheckboxEdit'] label input[id='SLOV']");
        this.click("button[id='apply']");
        console.log("Downloading Config_Graph_Check_7_Checked");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'Config_Graph_Check_7_Checked'+imageType);
        });
    });
    ...
    casper.then(function()
    {
        ...
        this.click("span[class='gridCheckboxEdit'] label input[id='SVIZ']");
        this.click("button[id='apply']");
        console.log("Downloading Config_Graph_Check_8_Checked");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'Config_Graph_Check_8_Checked'+imageType);
        });
    });
   ...
   //Download Data Button
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Download Data'] i",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Download Data'] i", "TEST9 --"+widgetTitle+" Download Button Exists");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Collapse'] i",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Collapse'] i", "TEST10 --"+widgetTitle+" Collapse Button Exists");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Fullscreen'] i",
        ...
        {
            console.log("Checking if Widget_"+widgetTitle+" the Download Button Exists");
            test.assertExists("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Fullscreen'] i", "TEST11 --"+widgetTitle+" Download Button Exists");
            console.log("Clicking on Download Button");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='widget-toolbar app_dropDownHolder dropDownHolder'] button[class='btn btn-primary dropdown-toggle dropDownTextStyle']",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] div[class='widget-toolbar app_dropDownHolder dropDownHolder'] button[class='btn btn-primary dropdown-toggle dropDownTextStyle']", "TEST12 --"+widgetTitle+" Border Button Exists");
        },
        function fail()
        {
            console.log("TEST12 --Widget Menu "+widgetTitle+" Border Button Does not Exists");
   ...
   //Display Graph 1
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='widget-toolbar app_dropDownHolder dropDownHolder'] ul[class='dropdown-menu .dropDownMenu'] li",
        ...
        {
            console.log("Checking if Widget_"+widgetTitle+" Menu Items Exists");
            test.assertExists("div[id='"+widgetID+"'] div[class='widget-toolbar app_dropDownHolder dropDownHolder'] ul[class='dropdown-menu .dropDownMenu'] li", "TEST13 --"+widgetTitle+" Menu Items Exists");
        ...
        function fail()
        {
            console.log("TEST13 --Widget Menu "+widgetTitle+" Configure Button Does not Exists");
