...
//Widget ID
var widgetID = "wid-id-103";
//Widget Title
var widgetTitle = "Power_CrossBorder_Flows_Nord_hourly";
//Needed to add this title as the title is as shown above but it wont save a image with a ":" within it
var widgetTitle2 ="Power CrossBorder Flows - Nord (hourly)";
...
casper.test.begin("Widget --> "+widgetTitle2+"",function (test)
{
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] svg g[class='highcharts-legend'] g g:nth-child(4)",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] svg g[class='highcharts-legend'] g g:nth-child(4)", "TEST17 --"+widgetTitle+" fourth child of the Legend Exists");
        },
        function fail()
        {
            console.log("TEST17 --Widget Menu "+widgetTitle+" fourth child of the Legend Does not Exists");
    ...
    //Check if the fifth child of the legend exists
    casper.waitForSelector("div[id='"+widgetID+"'] svg g[class='highcharts-legend'] g g:nth-child(5)",
        function success()
        {
            console.log("Checking if Widget_"+widgetTitle+" Legend fifth child Exists");
            test.assertExists("div[id='"+widgetID+"'] svg g[class='highcharts-legend'] g g:nth-child(5)", "TEST18 --"+widgetTitle+" fifth child of the Legend Exists");
        },
        function fail()
        {
            console.log("TEST18 --Widget Menu "+widgetTitle+" fifth child of the Legend Does not Exists");
    ...
    casper.then(function()
    {
        console.log("Clicking Fifth child of the Legends Button to reimplemented chart");
        this.click("div[id='"+widgetID+"'] svg g[class='highcharts-legend'] g g:nth-child(5)");
        //Screen Capture
        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'Legend_5_Clicked_Reimplemented'+imageType);
        });
    });
