...
casper.test.begin("Widget --> "+widgetTitle2+"",function (test)
{
    ...
    //Click on the ITALY PUN and capture image of change on table
    casper.waitForSelector("span[class='gridCheckboxEdit'] label input",
        function success()
        {
            ...
            test.assertExists("span[class='gridCheckboxEdit'] label input[id='ITALY PUN']", "TEST6 --"+widgetTitle+" Check Box Exists");
            console.log("Clicking on Check Box");
            this.click("span[class='gridCheckboxEdit'] label input[id='ITALY PUN']");
    ...
    //Click on the ITALY NORD and capture image of change on table
    casper.then(function()
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='ITALY NORD']");
        this.click("button[id='apply']");
    ...
    //Click on the FRANCE and capture image of change on table
    casper.then(function()
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='FRANCE']");
        this.click("button[id='apply']");
    ...
    //Click on the GERMANY and capture image of change on table
    casper.then(function()
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='GERMANY']");
        this.click("button[id='apply']");
    ...
    //Click on the SWITZERLAND and capture image of change on table
    casper.then(function()
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='SWITZERLAND']");
        this.click("button[id='apply']");
    ...
    //Click on the BELGIUM and capture image of change on table
    casper.then(function()
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='BELGIUM']");
        this.click("button[id='apply']");
    ...
    //Click on the AUSTRIA and capture image of change on table
    casper.then(function()
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='AUSTRIA']");
        this.click("button[id='apply']");
