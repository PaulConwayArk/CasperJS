...
//Widget ID
var widgetID = "wid-id-109";
//Widget Title
var widgetTitle = "Power_MGP_Volumes_Daily_Total";
//Needed to add this title as the title is as shown above but it wont save a image with a ":" within it
var widgetTitle2 ="Power MGP Volumes (daily total)";
...
casper.test.begin("Widget --> "+widgetTitle2+"",function (test)
{
    ...
    //Click on the SUD and capture image of change on table
    casper.then(function()
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='SUD']");
        this.click("button[id='apply']");
    ...
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='SICI']");
        this.click("button[id='apply']");
    ...
    //Click on the SARD and capture image of change on table
    casper.then(function()
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='SARD']");
        this.click("button[id='apply']");
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='widget-toolbar app_dropDownHolder dropDownHolder'] button[class='btn btn-primary dropdown-toggle dropDownTextStyle']",
        function success()
        {
            ...
            test.assertExists("div[id='"+widgetID+"'] div[class='widget-toolbar app_dropDownHolder dropDownHolder'] button[class='btn btn-primary dropdown-toggle dropDownTextStyle']", "TEST8 --"+widgetTitle+" Border Button Exists");
        },
        function fail()
        {
    ...
    casper.waitForSelector("div[id='"+widgetID+"'] div[class='widget-toolbar app_dropDownHolder dropDownHolder'] ul[class='dropdown-menu .dropDownMenu'] li",
        ...
        {
            console.log("Checking if Widget_"+widgetTitle+" Menu Items Exists");
            test.assertExists("div[id='"+widgetID+"'] div[class='widget-toolbar app_dropDownHolder dropDownHolder'] ul[class='dropdown-menu .dropDownMenu'] li", "TEST9 --"+widgetTitle+" Menu Items Exists");
