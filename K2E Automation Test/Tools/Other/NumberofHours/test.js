...
casper.test.begin("Widget --> "+widgetTitle+"",function (test)
{
    ...
    //Capture Image for Graph 7
    casper.then(function()
    {
        console.log("Downloading Config_Graph_7");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("button[class='btn btn-primary dropdown-toggle']");
        ...
        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'Config_Graph_7'+imageType);
        });
    });

    //Capture Image for Graph 8
    casper.then(function()
    {
        console.log("Downloading Config_Graph_8");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("button[class='btn btn-primary dropdown-toggle']");
        this.click("div[class='btn-group open'] ul li:nth-child(8) a");
        this.click("button[id='apply']");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'Config_Graph_8'+imageType);
        });
    });

    //Capture Image for Graph 9
    casper.then(function()
    {
        console.log("Downloading Config_Graph_9");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("button[class='btn btn-primary dropdown-toggle']");
        this.click("div[class='btn-group open'] ul li:nth-child(9) a");
        this.click("button[id='apply']");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'Config_Graph_9'+imageType);
        });
    });

    //Capture Image for Graph 10
    casper.then(function()
    {
        console.log("Downloading Config_Graph_10");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("button[class='btn btn-primary dropdown-toggle']");
        this.click("div[class='btn-group open'] ul li:nth-child(10) a");
        this.click("button[id='apply']");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'Config_Graph_10'+imageType);
        });
    });

    //Capture Image for Graph 11
    casper.then(function()
    {
        console.log("Downloading Config_Graph_11");
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("button[class='btn btn-primary dropdown-toggle']");
        this.click("div[class='btn-group open'] ul li:nth-child(11) a");
        this.click("button[id='apply']");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'Config_Graph_11'+imageType);
        });
    });
    ...
    casper.waitForSelector("span[class='gridCheckboxEdit'] label input",
        function success()
        {
            ...
            test.assertExists("span[class='gridCheckboxEdit'] label input[id='January']", "TEST8 --"+widgetTitle+" Check Box Exists");
            console.log("Clicking on Check Box");
            this.click("span[class='gridCheckboxEdit'] label input[id='January']");
            this.click("button[id='apply']");

            console.log("Downloading CheckBox_Check_January_1");
            this.wait(1000, function()
            {
                casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'CheckBox_Check_January_1'+imageType);
            });
        },
        function fail()
        {
    ...
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='February']");
        this.click("button[id='apply']");
        console.log("Downloading CheckBox_Check_February_2");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'CheckBox_Check_February_2'+imageType);
        });
    });
    ...
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='March']");
        this.click("button[id='apply']");
        console.log("Downloading CheckBox_Check_March_4");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'CheckBox_Check_March_3'+imageType);
        });
    });
    ...
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='April']");
        this.click("button[id='apply']");
        console.log("Downloading CheckBox_Check_April_4");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'CheckBox_Check_April_4'+imageType);
        });
    });
    ...
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='May']");
        this.click("button[id='apply']");
        console.log("Downloading CheckBox_Check_May_5");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'CheckBox_Check_May_5'+imageType);
        });
    });
    ...
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='June']");
        this.click("button[id='apply']");
        console.log("Downloading CheckBox_Check_June_6");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'CheckBox_Check_June_6'+imageType);
        });
    });
    ...
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='July']");
        this.click("button[id='apply']");
        console.log("Downloading CheckBox_Check_July_7");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'CheckBox_Check_July_7'+imageType);
        });
    });
    ...
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='August']");
        this.click("button[id='apply']");
        console.log("Downloading CheckBox_Check_August_8");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'CheckBox_Check_August_8'+imageType);
        });
    });
    ...
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='September']");
        this.click("button[id='apply']");
        console.log("Downloading CheckBox_September_Check_9");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'CheckBox_Check_September_9'+imageType);
        });
    });
    ...
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='October']");
        this.click("button[id='apply']");
        console.log("Downloading CheckBox_Check_October_10");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'CheckBox_Check_October_10'+imageType);
        });
    });
    ...
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='November']");
        this.click("button[id='apply']");
        console.log("Downloading CheckBox_Check_Check_11");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'CheckBox_Check_November_11'+imageType);
        });
    });
    ...
    {
        this.click("div[id='"+widgetID+"'] div[class='jarviswidget-ctrls'] a[title='Configure'] i");
        this.click("span[class='gridCheckboxEdit'] label input[id='December']");
        this.click("button[id='apply']");
        console.log("Downloading CheckBox_Check_Check_12");

        this.wait(1000, function()
        {
            casper.capture(imageLocation+'Widget_Menu_'+widgetTitle+'CheckBox_Check_December_12'+imageType);
        });
    });
